...
"""Initialization"""
os.chdir(os.path.dirname(os.path.abspath(__file__))) # path relative to file.
pg.mixer.init() #Initialize PyGame
pg.mixer.pre_init(44100, 16, 2, 4096)  #freq etc. settings for pygame mixer.
...
entry = tk.Entry(master = screen, borderwidth = 3, width = 25, 
textvariable = inputstring_var,  relief = RIDGE)
...
button_1 = tk.Button(master = screen, text = "Play your own song", padx = 45, 
                    pady = 5, width = 3, command = play_your_song)
